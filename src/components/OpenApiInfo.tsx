...
// Parent component.
const OpenApiInfo = createObjectComponent()
...
const Contact = createObjectComponent()
...
const License = createObjectComponent()
...
// Attach the child components to the parent component.
